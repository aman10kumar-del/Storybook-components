...
import { AvatarPropsExceptSize, HeaderSmallAvatarProps, MAX_TRAILING_ITEMS } from "../Header.types";
...
import s from "./HeaderSmallAvatar.module.scss";
import HeaderWrapper from "../HeaderWrapper";
import Button from "../../Button/Button";
import HeaderTrailing from "../HeaderTrailing";

const HeaderSmallAvatar: React.FC<HeaderSmallAvatarProps> = function ({
  TrailingIcons = [],
  TrailingLinks = [],
  showBack = true,
  onBackClick,  
      ...
      <Fragment>
        ...
        <div className={s.titlesContainer}>
          ...
          <div className={s.subTitleContainer}>
            ...
            {actionProps && (
              <Button 
                customClass={cx(s.actionButton, actionProps.customClass)}
                type="link"
                size="small"
                {...actionProps}
              />
...
export default HeaderSmallAvatar;
